...
// Define weather icons for weather conditions

// WeatherInfoIcons for additional weather information
  ...
  return (
    <div className='cityComponent'>
      ...
      <form className='searchBox' onSubmit={fetchWeather}>
        <input placeholder='Search City and Country' onChange={(event) => updateCity(event.target.value)} />
